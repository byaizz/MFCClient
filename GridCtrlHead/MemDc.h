...
public:
    ...
    CMemDC(CDC* pDC) : CDC()
    {
        ...
        else        // Make a copy of the relevent parts of the current DC 
                    // for printing
        {
#ifndef WCE_NO_PRINTING
    ...
    ~CMemDC()
    {
        ...
        {    
            ...
            m_pDC->BitBlt(m_rect.left, m_rect.top, m_rect.Width(), 
                          m_rect.Height(), this, m_rect.left, m_rect.top, 
                          SRCCOPY);
...
#endif 
// !defined(AFX_MEMDC_H__CA1D3541_7235_11D1_ABBA_00A0243D1382__INCLUDED_)
